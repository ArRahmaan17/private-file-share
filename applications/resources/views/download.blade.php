...
<head>
    ...
    <title>Download File - FileStream</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .o1 { width: 500px; height: 500px; background: #6366f1; top: -10%; right: -10%; transform: translate(0, 0); }
        .o2 { width: 400px; height: 400px; background: #3b82f6; bottom: -20%; left: -10%; animation-delay: -5s; }
        ...
        .file-icon svg { width: 36px; height: 36px; color: #a5a6ff; }
        ...
        .expiry { font-size: 14px; color: var(--text-secondary); margin-bottom: 24px; }
        
        .badge {
            display: inline-flex; align-items: center; justify-content: center;
            padding: 6px 14px; border-radius: 100px;
            font-size: 11px; font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase;
            background: var(--amber-soft); color: var(--amber); border: 1px solid rgba(251, 191, 36, 0.15);
            margin-bottom: 32px;
        }

        /* Form */
        .form-wrap { text-align: left; margin-bottom: 24px; }
        .label { display: block; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.08em; color: var(--text-secondary); padding-left: 4px; margin-bottom: 8px; }
        .input-field {
        ...
        .input-field.is-invalid { border-color: var(--red); box-shadow: 0 0 0 3px rgba(248, 113, 113, 0.15); }
        .error-text { color: var(--red); font-size: 12px; margin-top: 8px; padding-left: 4px; font-weight: 500; }

        /* Button */
        .btn-dl {
            width: 100%; background: linear-gradient(135deg, #6366f1, #7c3aed);
        ...
        .btn-dl:hover { transform: translateY(-2px); box-shadow: 0 8px 32px rgba(99, 102, 241, 0.4); }

...
<head>
    ...
    <title>Dashboard - FileStream Admin</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ambient .o1 { width: 700px; height: 700px; background: #6366f1; top: -30%; left: -15%; }
        .ambient .o2 { width: 500px; height: 500px; background: #a855f7; bottom: -25%; right: -10%; animation-delay: -8s; }
        .ambient .o3 { width: 350px; height: 350px; background: #3b82f6; top: 50%; left: 60%; animation-delay: -15s; }
        ...
        .topbar-link:hover { color: var(--text-primary); background: var(--bg-surface-hover); }
        .topbar-btn {
        ...
        .files-table tbody tr:hover { background: var(--bg-surface-hover); }
        .files-table td { padding: 18px 24px; vertical-align: middle; }
        ...
        /* Expiration cell */
        .expiry-form { display: flex; align-items: center; gap: 8px; }
        .expiry-input {
        ...
        .expiry-dot.live { background: var(--green); box-shadow: 0 0 6px var(--green); }
        .expiry-dot.warn { background: var(--amber); box-shadow: 0 0 6px var(--amber); }
        .expiry-dot.danger { background: var(--red); box-shadow: 0 0 6px var(--red); }
        ...
        .action-btn.view:hover { background: var(--accent-soft); }
        .action-btn.delete { color: var(--red); }
        .action-btn.delete:hover { background: var(--red-soft); }
        .action-btn.copy { color: var(--text-secondary); }
        .action-btn.copy:hover { background: var(--bg-surface-hover); color: var(--text-primary); }
        ...
        .tooltip {
            ...
            background: #1a1b23; border: 1px solid var(--border);
        ...
        /* Page entrance */
        .shell { animation: pageIn 0.5s cubic-bezier(0.16, 1, 0.3, 1) forwards; opacity: 0; }

...
<head>
    ...
    <title>Admin Login - FileStream</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ambient-bg .orb-1 { width: 600px; height: 600px; background: #6366f1; top: -20%; left: -10%; animation-delay: 0s; }
        .ambient-bg .orb-2 { width: 500px; height: 500px; background: #a855f7; bottom: -20%; right: -10%; animation-delay: -5s; }
        .ambient-bg .orb-3 { width: 300px; height: 300px; background: #3b82f6; top: 40%; left: 50%; animation-delay: -10s; }
        ...
        .login-wrapper {
            position: relative; z-index: 1; width: 100%; max-width: 420px; padding: 24px;
        }
        ...
        .brand p {
            color: var(--text-secondary); font-size: 13px; margin-top: 6px; font-weight: 400;
        }
        ...
        .error-msg {
            color: #f87171; font-size: 12px; margin-top: 8px; padding-left: 2px;
        }
